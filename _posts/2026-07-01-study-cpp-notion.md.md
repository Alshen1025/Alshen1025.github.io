...
![image.png](assets\img\c++\image.png)
...
![image.png](assets\img\c++\c++\image%201.png)
...
![image.png](assets\img\c++\image%202.png)

![image.png](assets\img\c++\image%203.png)
...
![image.png](assets\img\c++\image%204.png)
...
![image.png](assets\img\c++\image%205.png)
...
![image.png](assets\img\c++\image%206.png)
...
![image.png](assets\img\c++\image%207.png)
...
![image.png](assets\img\c++\image%208.png)

- 컨테이너 원소에 접근할 수 있는 포인터와 같은 객체
- 알고리즘 라이브러리에서 대부분이 반복자를 인자로 받아서 알고리즘을 수행함
- 반복자는 컨테이너의 iterator멤버 타입으로 정의되어 있음.

![image.png](assets\img\c++\image%209.png)

- 역 반복자도 존재함

### 리스트(list)

![image.png](assets\img\c++\image%2010.png)
...
![image.png](assets\img\c++\image%2011.png)
...
![image.png](assets\img\c++\image%2012.png)
...
![image.png](assets\img\c++\image%2013.png)
...
![image.png](assets\img\c++\image%2014.png)
...
![image.png](assets\img\c++\image%2015.png)

- 특정 자원을 몇 개의 객체에서 가리키는지를 추적한 다음에 그 수가 0이 되면 해제를 시켜줌
- 참조 카운트에 직접적으로 접근은 불가함.

![image.png](assets\img\c++\image%2016.png)
...
![image.png](assets\img\c++\image%2017.png)
...
![image.png](assets\img\c++\image%2018.png)
...
![image.png](assets\img\c++\image%2019.png)
...
![image.png](assets\img\c++\image%2020.png)

## 멀티 쓰레드를 사용하는 이유

### 병렬가능한(Parallelizable)작업들

![image.png](assets\img\c++\image%2021.png)
...
![image.png](assets\img\c++\image%2022.png)

- 하지만 멀티 쓰레드를 사용하면 기다리는 시간 낭비를 줄일 수 있음

![image.png](assets\img\c++\image%2023.png)
...
![image.png](assets\img\c++\image%2024.png)
...
![image.png](assets\img\c++\image%2025.png)
